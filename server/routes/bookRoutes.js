...
router
  .route("/book/review/:bookId")
  .post(bookControllers.reviewBook)
  .put(bookControllers.editReview)
  .delete(bookControllers.deleteReview); //review a book, only logged in users can review a book
